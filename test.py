...
def visualize(dom, states_xy, pred_traj):
    ...
    #can add a plt.savefig() if we want to save the output
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--weights',
        type=str,
        default='trained/vin_8x8.pth', #original
        help='Path to trained weights')
    parser.add_argument('--plot', action='store_true', default=True)  #makes it default to plot, normally false
